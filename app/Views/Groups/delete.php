        ...
        <div class="block">
            ...
            <div class="block-body">
                <div class="form-group mt-5 mb-4">
                    ...
                    <a href="<?php echo site_url("groups/show/$group->id") ?>" class="btn btn-secondary btn-sm ml-2">Back</a>
                </div>
            </div>
...
<script>
    $(document).ready(function(){
        ...
        $("#form").on('submit', function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url('groups/delete') ?>',
                ...
                success: function(response){
                    ...
                    if(!response.error)
                    {
                        ...
                        {
                            window.location.href = "<?php echo site_url("groups/show/$group->id"); ?>"
                        }
                    }
                    if(response.error)
                    {
